 ...
 * @desc Classe de Tratamento de Camada de Regras de Negócio (Barras Clientes)
...
class negocio_custom_barras_clientes extends negocio_custom {

	/**
	 * @desc Realiza customização de Select de Barras de Clientes
	*/
    function select_barras_clientes(){
        if ($_GET["select"] == 1){
